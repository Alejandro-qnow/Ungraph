...
Este documento es un **punto de retomada** para desarrolladores y agentes: resume **qué está hecho**, **dónde está en el código** y **qué sigue**, sin sustituir a [`PRODUCT.md`](../product/PRODUCT.md), [`VISION_AND_TUTORIALS.md`](../product/VISION_AND_TUTORIALS.md) ni [`../agent/AGENT_SKILLS.md`](../../agent/AGENT_SKILLS.md).
...
| [`PRODUCT.md`](../product/PRODUCT.md) | Jerarquía maestra de producto |
| [`ROADMAP_LEVEL_C.md`](../experiment/ROADMAP_LEVEL_C.md) | Horizonte nivel C (plan maestro); entrega prioritaria = A+B |
